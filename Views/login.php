...
<body>
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="./process/checkLogin.php" method="POST">
            <div>
            ...
            Not a member?
            <a href="./register.php" class="font-semibold text-indigo-600 hover:text-indigo-500">Create your account</a>
            </p>
        </div>
    </div>
</body>
