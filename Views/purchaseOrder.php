      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="./process/checkBuyProduct.php" method="POST">
            ...
            <div>
                ...
                <div class="mt-2">
                <input type="text" name="date" readonly value="<?php echo date('Y-m-d'); ?>" class="block w-full bg-gray-100 rounded-md border-0 px-1.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-2">
                <input type="text" readonly value="<?php echo htmlspecialchars($customer['Name']); ?>" class="block w-full bg-gray-100 rounded-md border-0 px-1.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-2">
                <input type="text" name="quantity" value="1" class="block w-full rounded-md border-0 px-1.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                </div>
            </div>
            ...
            <div>
                ...
                <div class="mt-2">
                <input type="text" name="price" readonly value="<?php echo htmlspecialchars($result['Price']); ?>" class="block w-full bg-gray-100 rounded-md border-0 px-1.5 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm/6">
                </div>
            </div>
            ...
            <div>
                <input type="hidden" name="product_id" value="<?= htmlspecialchars($result['BookID']) ?>">
