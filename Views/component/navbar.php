            ...
            <div class="border-b border-gray-200">
                <div class="flex h-16 items-center">
                    ...
                    <div class="ml-4 flex lg:ml-0">
                        ...
                        <img class="h-10 w-auto" src="../images/books.png" alt="">
                        </a>
                    </div>
                        ...
                        <div class="ml-4 flow-root lg:ml-6">
                            <?php if (isset($_SESSION["userid"])): ?>
                                ...
                                <a href="./customerForm.php" class="group -m-2 flex items-center p-2">
                                    <img class="h-9 w-auto" src="../images/userLogin.png" alt="userLogin.png">
                                </a>
                            <?php else: ?>
                                <!-- หากผู้ใช้ยังไม่ได้ล็อกอิน -->
                                <a href="./login.php" class="group -m-2 flex items-center p-2">
                                    <img class="h-9 w-auto" src="../images/userLogout.png" alt="userLogout.png">
                                </a>
                            <?php endif; ?>
                            <!-- <a href="./customerForm.php" class="group -m-2 flex items-center p-2">
                                <img class="h-9 w-auto" src="../images/userLogin.png" alt="userLogin.png">
